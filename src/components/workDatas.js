export const workDatas = [

  {
    id: 0,
    client: "Royal Time",
    icon: require("../assets/Royal-Time_logo.svg").default,
...

  {
    ...
    client: "Bymark",
    title: "UI Designer",
    icon: require("../assets/Bymark_Logo.svg").default,
    position: "Bymark",
    date: "High School",
    location: "Milan, Italy",
    graphicTools: [
  ...
  ]},
  {
    ...
    title: "Product Designer",
    icon: require("../assets/EA.svg").default,
    position: "European Aerosols",
    date: "2015 - 2016",
    ...
    ]},
  {
    ...
    icon: require("../assets/2000Network_Logo.png"),
    position: "2000 Network",
    date: "2016 - 2023",
    location: "Milan, Italy",
    institute: "",
    graphicTools: [
